...
In conclusion, this study combine:
PS-InSAR (mm precision), ANN, and RF to model the 
...
1. Identify policy, is it right?
(e.g. coolroof/painting white, indonesian resrtiction of groundwater extraction by fare)
2. 
...
1. Feasibility study
2. Work flow
3. 4000 pound, 2-3 GIS analyst in the government
